...
The deterministic difficult case maximizes the sum, across methods, of $\sqrt{(s_u/q_u)^2+(s_x/q_x)^2}$. It is sample 80.

RRT verified waypoints: (0.36,2.68), (0.57,1.76), (0.85,1.56), (1.18,1.44), (1.83,1.71), (2.38,2.17), (2.92,2.62), (3.45,2.68).\\
LLM verified waypoints: (0.36,2.68), (0.70,3.12), (1.62,3.03), (2.53,2.83), (3.45,2.68).
\begin{center}\begin{tabular}{lrrrrr}\toprule
Method & $s_u$ & $s_x$ & $q_u$ & $q_x$ & asymptotic radius term [m]\\\midrule
Different clocks & 2.8156 & 2.0555 & 2.3799 & 1.2813 & 20.2188 \\
Shared clock & 2.3408 & 2.0107 & 2.0227 & 1.0569 & 16.8492 \\
Frenet & 1.9912 & 1.5982 & 1.9028 & 1.2247 & 18.2556 \\
Guided shared & 3.2253 & 1.6176 & 1.8772 & 0.6994 & 12.6990 \\
...
\begin{figure}[ht]\centering\includegraphics[width=.92\linewidth]{xu_method_paths.png}\caption{Expert and actual predicted paths.}\end{figure}
\begin{figure}[ht]\centering\includegraphics[width=.92\linewidth]{xu_method_progress.png}\caption{Wall-clock schedule versus spatial progress.}\end{figure}
\begin{figure}[ht]\centering\includegraphics[width=.92\linewidth]{xu_method_errors.png}\caption{Time-indexed diagnostic state/control errors. Frenet calibration itself uses progress-aligned errors.}\end{figure}
