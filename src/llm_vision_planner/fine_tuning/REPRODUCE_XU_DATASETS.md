...
python3 fine_tuning/scripts/dataset_generator.py \
  --prediction-pairs --samples 2001 \
...
/usr/bin/python3 fine_tuning/scripts/dataset_generator.py --prediction-pairs --samples 5000 --output fine_tuning/datasets/conformal_rrt_prediction_pairs_5000.csv
