...
\href{https://github.com/prachitgupta/starling_testing_ws}{starling\_testing\_ws}.
\end{abstract}
...
\begin{center}
\href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/launch/full_plot.launch.py}{full\_plot.launch.py}
\end{center}
...
\begin{itemize}
  \item Prompt generation: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/scripts/prompt_generator.py}{prompt\_generator.py}
  \item LLM planner: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/scripts/llm_planner.py}{llm\_planner.py}
  \item Refinement: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/scripts/refinment.py}{refinment.py}
  \item Verification: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/scripts/verifier.py}{verifier.py}
  \item PX4 trajectory follower: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/scripts/trajectory_follower.py}{trajectory\_follower.py}
  \item Hardware test README: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/HARDWARE_TESTING_README.md}{HARDWARE\_TESTING\_README.md}
  \item Hardware setup guide: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/setup_guide.md}{setup\_guide.md}
\end{itemize}
...
\href{https://github.com/prachitgupta/starling_testing_ws/tree/main/src/starling_testing/flight_logs/test_run_videos}{GitHub folder containing screen recordings and hardware/simulation videos}
\end{center}
...
\begin{itemize}
  \item Sparse waypoint predictions: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/plots/simulated_test_sparse_waypoint_predictions.png}{static sparse plot}
  \item Refined trajectory waiting for verification: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/plots/simulated_test_refined_trajectory_waiting_for_verification.png}{static refined plot}
  \item Latched verified trajectory: \href{https://github.com/prachitgupta/starling_testing_ws/blob/main/src/llm_vision_planner/plots/simulated_test_latched_verified_trajectory.png}{static verified plot}
\end{itemize}
